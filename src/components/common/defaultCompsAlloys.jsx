...
export default function DefaultCompsAlloys(props) {
  const { t } = useTranslation(['Machines']);
  return (
    <>
      <div className='flex items-center md:hidden'>
        <Link to={process.env.PUBLIC_URL + `/`}>
          <button className='mx-4 flex items-center rounded bg-white p-2  pl-3'>
      ...
      <HeaderContent>
        <div className='mt-[15px] flex h-11 w-full justify-center 3xl:mt-[1.9vh] 3xl:mx-auto 3xl:w-[70%] 3xl:h-[3.7vh]'>
          ...
          >
            ...
            <div className='hidden md:block'>{t('scan')}</div>
          </button>
        </div>
      </HeaderContent>
    </>
