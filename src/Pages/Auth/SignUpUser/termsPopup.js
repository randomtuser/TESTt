...
function TermsPopup() {
  return (
    <div className='text-black'>
      ...
      <h1 className='text-left text-lg'>Interpretation and Definitions</h1>
      <h1 className='text-left text-lg'>Interpretation</h1>
      The words of which the initial letter is capitalized have meanings defined under the following
      conditions. The following definitions shall have the same meaning regardless of whether they
      appear in singular or in plural.
      <h1 className='text-left text-lg'>Definitions</h1>
      ...
      <h1 className='text-lg font-semibold'>Use of Your Personal Data</h1>
      ...
      <h1 className='text-lg font-bold'>Retention of Your Personal Data</h1>
      <p>
      ...
      <h1 className='text-lg font-bold'>Transfer of Your Personal Data</h1>
      <p>
      ...
      <h1 className='font-size text-lg'>Delete Your Personal Data</h1>
      <p>
      ...
      <h1 className='text-lg font-semibold'>Disclosure of Your Personal Data</h1>
      ...
      <h1 className='text-lg font-bold'>Law enforcement</h1>
      <p>
        Under certain circumstances, the Company may be required to disclose Your Personal Data if
        required to do so by law or in response to valid requests by public authorities (e.g. a
        court or a government agency).
      </p>
      <h1 className='text-lg font-semibold'>Other legal requirements</h1>
      ...
      <h1 className='text-lg font-semibold'>Security of Your Personal Data</h1>
      <p>
      ...
      <ul className='list-disc'>
        <li>By visiting this page on our website: https://metalmaker3d.com/pages/contact</li>
      </ul>
