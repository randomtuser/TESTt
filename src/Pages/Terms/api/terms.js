  ...
  const termsData = {
    ...
    description: {
      introduction: [
        ...
        website located at metalmaker3d.com (together or individually “Service”) operated
        by MetalMaker3D.`,
      ...
      communications: [
        ...
        unsubscribe link or by emailing at support@metalmaker3d.com.`,
      ],
      ...
      content: [
        ...
        on or through Service and you are responsible for protecting those rights. We take
        ...
        `MetalMaker3D has the right but not the obligation to monitor and edit all Content
        provided by users.`,
        `In addition, Content found on or through this Service are the property of
        MetalMaker3D or used with permission. You may not distribute, modify, transmit,
      ...
      intellectual: [
        ...
        and functionality are and will remain the exclusive property of MetalMaker3D and
        its licensors. Service is protected by copyright, trademark, and other laws of and
        foreign countries. Our trademarks may not be used in connection with any product
        or service without the prior written consent of MetalMaker3D.`,
      ],
      copyright: [
        ...
        infringement, please submit your claim via email to support@metalmaker3d.com, with
    ...
    of the owner of the copyright’s interest;`,
        ...
        `You can contact our Copyright Agent via email at support@metalmaker3d.com.`,
      ],
      error: [
        `You may provide us either directly at support@metalmaker3d.com or via third party
      ...
      links: [
        ...
        owned or controlled by MetalMaker3D.`,
        `MetalMaker3D has no control over, and assumes no responsibility for the content,
      ...
      limitation: [
        ...
        CONSEQUENTIAL DAMAGE, HOWEVER IT ARISES (INCLUDING ATTORNEYS’ FEES AND ALL RELATED
        COSTS AND EXPENSES OF LITIGATION AND ARBITRATION, OR AT TRIAL OR ON APPEAL, IF
        ANY, WHETHER OR NOT LITIGATION OR ARBITRATION IS INSTITUTED), WHETHER IN AN ACTION
        ...
        PERSONAL INJURY OR PROPERTY DAMAGE, ARISING FROM THIS AGREEMENT AND ANY VIOLATION
        BY YOU OF ANY FEDERAL, STATE, OR LOCAL LAWS, STATUTES, RULES, OR REGULATIONS, EVEN
        IF COMPANY HAS BEEN PREVIOUSLY ADVISED OF THE POSSIBILITY OF SUCH DAMAGE. EXCEPT
        AS PROHIBITED BY LAW, IF THERE IS LIABILITY FOUND ON THE PART OF COMPANY, IT WILL
        ...
        ALLOW THE EXCLUSION OR LIMITATION OF PUNITIVE, INCIDENTAL OR CONSEQUENTIAL
      ...
      governing: [
        `These Terms shall be governed and construed in accordance with the laws of United
        States of America, which governing law applies to agreement without regard to its
